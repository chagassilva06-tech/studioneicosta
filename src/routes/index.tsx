        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10 py-14 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          >
            ...
            <img
              ...
              loading="lazy"
              className="relative rounded-2xl border border-sky-400/30 w-full aspect-[9/16] object-contain p-4 shadow-[0_0_60px_-15px_rgba(56,155,255,0.4)] transition-all duration-500 group-hover:scale-[1.03] group-hover:border-sky-300 group-hover:shadow-[0_0_80px_-10px_rgba(56,155,255,0.75)]"
            />
          </motion.div>
          <div>
